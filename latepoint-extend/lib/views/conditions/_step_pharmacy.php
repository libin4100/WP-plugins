<div class="step-qha-time-w latepoint-step-content" data-step-name="pharmacy">
    <div class="os-row">
    <?php
        echo OsFormHelper::text_field('booking[qhc][pharmacy_password]', 'Password', $booking->get_meta_by_key('pharmacy_password', ''), ['class' => 'os-form-control pharmacy-password', 'placeholder' => 'Password'], array('class' => 'os-col-12'));
