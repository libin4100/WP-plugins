jQuery(function ($) {
    ...
    var fields = {
        ...
        "ka23othg": { action: 'check_certificate_by', by: 'sp', agent_id: 'input[name="restrictions[selected_agent]"' },
    }
    ...
    setInterval(function () {
        ...
        if ($('#booking_custom_fields_cf_wfhtigvf').length && $('#booking_custom_fields_cf_wfhtigvf').attr('type') == 'text') {
            $('#booking_custom_fields_cf_wfhtigvf').attr('type', 'date').attr('max', new Date().toISOString().split('T')[0]);
